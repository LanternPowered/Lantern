...
object SelectorTypeRegistryModule : AdditionalPluginCatalogRegistryModule<SelectorType>(SelectorTypes::class) {
    ...
    override fun registerDefaults() {
        register(LanternSelectorType(NamespacedKeys.minecraft("all_players"), "a"))
        register(LanternSelectorType(NamespacedKeys.minecraft("all_entities"), "e"))
        register(LanternSelectorType(NamespacedKeys.minecraft("nearest_player"), "p"))
        register(LanternSelectorType(NamespacedKeys.minecraft("random"), "r"))
    }
