...
public abstract class PacketPlayOutTeams implements Packet {

    private final String teamName;

    private PacketPlayOutTeams(String teamName) {
    ...
    public static final class Remove extends PacketPlayOutTeams {
    ...
    public static abstract class CreateOrUpdate extends PacketPlayOutTeams {
    ...
    public static abstract class AddOrRemovePlayers extends PacketPlayOutTeams implements Members {
