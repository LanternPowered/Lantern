...
object UpdateViewPositionEncoder : PacketEncoder<UpdateViewPositionPacket> {

    override fun encode(ctx: CodecContext, packet: UpdateViewPositionPacket): ByteBuffer {
