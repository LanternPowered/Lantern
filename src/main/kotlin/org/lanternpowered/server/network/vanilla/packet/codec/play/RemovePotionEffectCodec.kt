...
object RemovePotionEffectCodec : PacketEncoder<RemovePotionEffectPacket> {

    override fun encode(context: CodecContext, packet: RemovePotionEffectPacket): ByteBuffer {
