...
object ClientSetDifficultyDecoder : PacketDecoder<ClientSetDifficultyPacket> {

    override fun decode(ctx: CodecContext, buf: ByteBuffer): ClientSetDifficultyPacket =
