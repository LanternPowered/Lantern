...
public final class HandlerPlayInUnregisterChannels implements Handler<UnregisterChannelsPacket> {

    @Override
    public void handle(NetworkContext context, UnregisterChannelsPacket packet) {
