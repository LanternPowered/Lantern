...
object WorldBorderEncoder : PacketEncoder<WorldBorderPacket> {

    override fun encode(ctx: CodecContext, packet: WorldBorderPacket): ByteBuffer {
        val buf = ctx.byteBufAlloc().buffer()
        when (packet) {
            is WorldBorderPacket.Init -> {
