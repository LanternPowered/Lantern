...
object SetActiveScoreboardObjectiveEncoder : PacketEncoder<SetActiveScoreboardObjectivePacket> {

    override fun encode(ctx: CodecContext, packet: SetActiveScoreboardObjectivePacket): ByteBuffer {
