...
object ClientPlayerMovementAndLookDecoder : PacketDecoder<ClientPlayerMovementAndLookPacket> {

    override fun decode(ctx: CodecContext, buf: ByteBuffer): ClientPlayerMovementAndLookPacket {
