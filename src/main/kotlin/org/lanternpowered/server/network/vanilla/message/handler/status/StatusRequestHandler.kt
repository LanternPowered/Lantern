...
class StatusRequestHandler : Handler<StatusRequestMessage> {

    private val gson = Gson()

    override fun handle(context: NetworkContext, message: StatusRequestMessage) {
        ...
        session.send(StatusResponseMessage(this.gson.toJson(rootObject)))
    }
}
