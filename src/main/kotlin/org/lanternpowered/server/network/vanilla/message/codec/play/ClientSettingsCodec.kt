...
class ClientSettingsCodec : Codec<ClientSettingsMessage> {
    ...
    override fun decode(context: CodecContext, buf: ByteBuffer): ClientSettingsMessage {
        ...
        return ClientSettingsMessage(locale, viewDistance, visibility, dominantHand, enableColors, skinPartsBitPattern)
    }
}
