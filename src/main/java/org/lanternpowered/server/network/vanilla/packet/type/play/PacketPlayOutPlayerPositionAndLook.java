...
public final class PacketPlayOutPlayerPositionAndLook implements Packet {
    ...
    public PacketPlayOutPlayerPositionAndLook(Vector3d position, float yaw, float pitch,
