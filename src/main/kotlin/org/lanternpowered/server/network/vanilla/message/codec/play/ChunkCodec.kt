...
class ChunkCodec : Codec<ChunkMessage> {

    override fun encode(context: CodecContext, message: ChunkMessage): ByteBuffer {
        ...
        buf.writeBoolean(message is ChunkMessage.Init)
        ...
        if (message is ChunkMessage.Init) {
