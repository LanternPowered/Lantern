...
object ClientPlayerVehicleMovementDecoder : PacketDecoder<ClientPlayerVehicleMovementPacket> {

    override fun decode(ctx: CodecContext, buf: ByteBuffer): ClientPlayerVehicleMovementPacket {
