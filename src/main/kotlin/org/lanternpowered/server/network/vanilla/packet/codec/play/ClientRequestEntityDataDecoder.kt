...
object ClientRequestEntityDataDecoder : PacketDecoder<ClientRequestDataPacket.Entity> {

    override fun decode(ctx: CodecContext, buf: ByteBuffer): ClientRequestDataPacket.Entity {
