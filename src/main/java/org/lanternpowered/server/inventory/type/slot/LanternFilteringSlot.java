...
public class LanternFilteringSlot extends AbstractInventorySlot implements FilteringSlot {
    ...
    protected static class ContainerSlot extends AbstractContainerSlot implements FilteringSlot {
    }
}
