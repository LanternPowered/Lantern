...
object ClientRecipeBookStateHandler : PacketHandler<ClientRecipeBookStatePacket> {

    override fun handle(ctx: NetworkContext, packet: ClientRecipeBookStatePacket) {
