...
val RotationRegistry = catalogTypeRegistry<Rotation> {
    fun register(id: String, angle: Int) =
            register(LanternRotation(CatalogKey.minecraft(id), angle))
...
private class LanternRotation(key: CatalogKey, private val angle: Int) : DefaultCatalogType(key), Rotation {
