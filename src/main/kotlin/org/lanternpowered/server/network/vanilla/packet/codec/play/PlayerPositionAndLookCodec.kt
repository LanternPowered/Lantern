...
object PlayerPositionAndLookCodec : PacketEncoder<PlayerPositionAndLookPacket> {

    override fun encode(context: CodecContext, packet: PlayerPositionAndLookPacket): ByteBuffer {
