 ...
 */
package org.lanternpowered.server.network.vanilla.packet.type.handshake
 ...
 */
data class HandshakePacket(val nextState: Int, val hostname: String, val port: Int, val protocolVersion: Int) : Packet
