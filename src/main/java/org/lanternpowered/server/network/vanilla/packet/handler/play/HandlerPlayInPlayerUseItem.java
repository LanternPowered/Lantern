...
public class HandlerPlayInPlayerUseItem implements Handler<ClientPlayerUseItemPacket> {

    @Override
    public void handle(NetworkContext context, ClientPlayerUseItemPacket packet) {
