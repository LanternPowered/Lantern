...
object ClientRequestBlockDataDecoder : PacketDecoder<ClientRequestDataPacket.Block> {

    override fun decode(ctx: CodecContext, buf: ByteBuffer): ClientRequestDataPacket.Block {
