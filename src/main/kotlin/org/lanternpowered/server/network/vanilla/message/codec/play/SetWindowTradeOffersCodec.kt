...
class SetWindowTradeOffersCodec : Codec<SetWindowTradeOffersMessage> {

    override fun encode(context: CodecContext, message: SetWindowTradeOffersMessage): ByteBuffer {
