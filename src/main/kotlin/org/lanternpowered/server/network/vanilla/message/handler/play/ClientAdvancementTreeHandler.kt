...
class ClientAdvancementTreeHandler : Handler<ClientAdvancementTreeMessage> {

    override fun handle(context: NetworkContext, message: ClientAdvancementTreeMessage) {
        if (message is ClientAdvancementTreeMessage.Open) {
            val id = message.id
