...
class ClientBlockPlacementCodec : Codec<ClientBlockPlacementMessage> {

    override fun decode(context: CodecContext, buf: ByteBuffer): ClientBlockPlacementMessage {
        ...
        return ClientBlockPlacementMessage(position, offset, face, hand, insideBlock)
    }
}
