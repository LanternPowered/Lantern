...
object BlockBreakAnimationCodec : PacketEncoder<BlockBreakAnimationPacket> {

    override fun encode(context: CodecContext, packet: BlockBreakAnimationPacket): ByteBuffer {
