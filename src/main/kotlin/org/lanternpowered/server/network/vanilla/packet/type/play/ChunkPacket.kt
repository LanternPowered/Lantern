...
sealed class ChunkPacket(
    ...
    class Init(x: Int, z: Int, sections: Array<Section?>, val biomes: IntArray) : ChunkPacket(x, z, sections)

    class Update(x: Int, z: Int, sections: Array<Section?>) : ChunkPacket(x, z, sections)
