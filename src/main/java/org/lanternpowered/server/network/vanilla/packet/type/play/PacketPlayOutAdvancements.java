...
public final class PacketPlayOutAdvancements implements Packet {
    ...
    public PacketPlayOutAdvancements(boolean clear, List<NetworkAdvancement> added, List<String> removed,
