...
class ClientClickWindowCodec : Codec<ClientClickWindowMessage> {

    override fun decode(context: CodecContext, buf: ByteBuffer): ClientClickWindowMessage {
        return buf.run {
            ...
            ClientClickWindowMessage(windowId, slot, mode, button, transaction, clickedItem)
        }
    }
}
