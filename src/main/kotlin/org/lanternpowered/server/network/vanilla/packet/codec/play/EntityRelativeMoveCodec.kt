...
object EntityRelativeMoveCodec : PacketEncoder<EntityRelativeMovePacket> {

    override fun encode(context: CodecContext, packet: EntityRelativeMovePacket): ByteBuffer {
