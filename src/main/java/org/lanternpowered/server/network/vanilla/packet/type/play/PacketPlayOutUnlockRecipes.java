...
public abstract class PacketPlayOutUnlockRecipes implements Packet {
    ...
    private PacketPlayOutUnlockRecipes(
    ...
    public final static class Remove extends PacketPlayOutUnlockRecipes {
    ...
    public final static class Init extends PacketPlayOutUnlockRecipes {
    ...
    public final static class Add extends PacketPlayOutUnlockRecipes {
