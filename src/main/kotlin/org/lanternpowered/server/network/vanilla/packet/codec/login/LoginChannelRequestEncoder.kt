...
object LoginChannelRequestEncoder : PacketEncoder<LoginChannelRequestPacket> {

    override fun encode(ctx: CodecContext, packet: LoginChannelRequestPacket): ByteBuffer {
