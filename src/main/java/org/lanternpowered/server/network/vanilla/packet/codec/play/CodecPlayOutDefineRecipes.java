...
public final class CodecPlayOutDefineRecipes implements Codec<PacketPlayOutDefineRecipes> {
    ...
    @Override
    public ByteBuffer encode(CodecContext context, PacketPlayOutDefineRecipes packet) throws CodecException {
        final ByteBuffer buf = context.byteBufAlloc().buffer();
        final List<NetworkRecipe> recipes = packet.getRecipes();
