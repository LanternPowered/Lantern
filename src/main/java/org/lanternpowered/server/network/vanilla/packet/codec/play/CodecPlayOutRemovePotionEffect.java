...
public final class CodecPlayOutRemovePotionEffect implements Codec<PacketPlayOutRemovePotionEffect> {

    @Override
    public ByteBuffer encode(CodecContext context, PacketPlayOutRemovePotionEffect message) throws CodecException {
