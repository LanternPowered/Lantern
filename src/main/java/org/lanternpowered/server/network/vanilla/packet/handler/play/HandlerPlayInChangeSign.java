...
public final class HandlerPlayInChangeSign implements Handler<PacketPlayInChangeSign> {

    @Override
    public void handle(NetworkContext context, PacketPlayInChangeSign packet) {
        final LanternPlayer player = context.getSession().getPlayer();
        final Optional<Vector3i> openedSignPos = player.getOpenedSignPosition();
        final Vector3i signPos = packet.getPosition();
        ...
        optTileEntity
                ...
                .ifPresent(tile -> {
                    ...
                    signData.set(Keys.SIGN_LINES, Arrays.stream(packet.getLines())
                            .<Text>map(Text::of)
