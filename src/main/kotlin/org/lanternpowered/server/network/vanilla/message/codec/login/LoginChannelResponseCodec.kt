...
class LoginChannelResponseCodec : Codec<LoginChannelResponseMessage> {

    override fun decode(context: CodecContext, buf: ByteBuffer): LoginChannelResponseMessage {
        ...
        return LoginChannelResponseMessage(transactionId, content)
    }
}
