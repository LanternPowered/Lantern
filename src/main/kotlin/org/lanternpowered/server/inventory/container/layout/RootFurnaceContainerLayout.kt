...
class RootFurnaceContainerLayout : RootSmeltingContainerLayout(TITLE) {

    override val windowType: ClientWindowType get() = ClientWindowTypes.FURNACE

    companion object {

        private val TITLE = translatableTextOf("container.furnace")
    }
}
