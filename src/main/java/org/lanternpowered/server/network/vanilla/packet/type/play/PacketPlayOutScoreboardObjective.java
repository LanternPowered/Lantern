...
public abstract class PacketPlayOutScoreboardObjective implements Packet {

    private final String objectiveName;

    PacketPlayOutScoreboardObjective(String objectiveName) {
    ...
    public static final class Remove extends PacketPlayOutScoreboardObjective {
    ...
    public static abstract class CreateOrUpdate extends PacketPlayOutScoreboardObjective {
